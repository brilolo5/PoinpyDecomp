function uiTemplateTextScaledLimit(arg0, arg1, arg2)
{
    text = arg0;
    textSize = arg1;
    visBlend = make_color_rgb(255, 255, 255);
    textElement = scribble(text).starting_format(locGetFontFromLanguage(), make_color_rgb(255, 255, 255)).msdf_border(make_color_rgb(46, 50, 59), 3).transform(0.5 * arg1, 0.5 * arg1, 0).scale_to_box(arg2, -1);
