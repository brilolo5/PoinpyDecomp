...
{
    uiFocusCursor("AE root", device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), input_check("menu select"), input_check("menu back"));
}
else if (input_player_source_get() == UnknownEnum.Value_2)
{
    ...
    uiFocusGamepad("AE root", _dx, _dy, input_check("menu select"), input_check("menu back"));
}
