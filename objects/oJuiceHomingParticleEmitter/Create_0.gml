...
else
{
    ...
    splineX2 = splineX3;
    bezierSpeed = 0.02631578947368421;
}

starJuice = global.currentLevelChunkSet == UnknownEnum.Value_6 || (global.gameReinitializeState == "puzzle" && global.puzzleCurrentTheme == UnknownEnum.Value_6);

if (starJuice)
{
    starColorArray[0] = make_color_rgb(36, 145, 249);
    starColorArray[1] = make_color_rgb(65, 231, 125);
    starColorArray[2] = make_color_rgb(225, 223, 1);
    starColorArray[3] = make_color_rgb(255, 255, 255);
    starColorMax = 4;
}
...
myAlarm0 = new makeAlarm(3, function()
{
    while (myAlarm0.alarmTimer <= 0)
    {
        ...
        array_set(_particle, UnknownEnum.Value_0, sFruitDewWhite);
        ...
        {
            var _i = round(spawnCount) % starColorMax;
            array_set(_particle, UnknownEnum.Value_1, starColorArray[_i]);
        }
