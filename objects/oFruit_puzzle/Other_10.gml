...
if (golden)
{
    ...
    var _goldenOutlineScale = 0.1 * (1.3 + _glowRadius);
...
draw_sprite_ext(sprIndex, image_index, x + cx, y + cy, 0.1, 0.1, imageAngle, c_white, image_alpha);
