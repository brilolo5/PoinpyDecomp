...
if (animationSpeed > 0)
{
    ...
    imageIndex += (animationSpeed * gts);
    
    if (imageIndex >= image_number && destroyAfterAnimation)
        instance_destroy();
}

if (_draw)
    draw_sprite_ext(sprite_index, image_index, x + cx, y + cy, xscale, yscale, imageAngle * xDirection, setColor, 1);
